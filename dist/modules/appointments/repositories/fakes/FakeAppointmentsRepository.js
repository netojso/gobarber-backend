    ...
    AppointmentsRepository.prototype.findByDate = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                appointment = this.appointments.find(function (result) { return date_fns_1.isEqual(result.date, date); });
                return [2 /*return*/, appointment];
            });
        });
    };
    AppointmentsRepository.prototype.create = function (_a) {
        var barber_id = _a.barber_id, date = _a.date;
        return __awaiter(this, void 0, void 0, function () {
            var appointment;
            return __generator(this, function (_b) {
                appointment = new Appointment_1.default();
                Object.assign(appointment, { id: uuidv4_1.uuid(), date: date, barber_id: barber_id });
