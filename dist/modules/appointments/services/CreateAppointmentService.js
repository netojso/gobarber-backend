...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        var date = _a.date, barber_id = _a.barber_id;
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentSameData, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        findAppointmentSameData = _b.sent();
                        if (findAppointmentSameData) {
                            throw new AppError_1.default('Appointment is already booked');
                        }
