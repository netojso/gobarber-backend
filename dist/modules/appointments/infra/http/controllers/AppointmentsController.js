...
var AppointmentsController = /** @class */ (function () {
    ...
    AppointmentsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, barber_id, date, parsedDate, createdAppointment, appointment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, barber_id = _a.barber_id, date = _a.date;
                        parsedDate = date_fns_1.parseISO(date);
                        createdAppointment = tsyringe_1.container.resolve(CreateAppointmentService_1.default);
                        return [4 /*yield*/, createdAppointment.execute({
                                barber_id: barber_id,
                                date: parsedDate
                            })];
                    case 1:
