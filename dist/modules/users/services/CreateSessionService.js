...
var CreateSessionService = /** @class */ (function () {
    ...
    CreateSessionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordVerify, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        user = _c.sent();
                        if (!user) {
                            throw new AppError_1.default('Your email/password is incorrect', 401);
                        }
                        return [4 /*yield*/, this.hashProvider.compareHash(password, user.password)];
                    case 2:
                        passwordVerify = _c.sent();
                        if (!passwordVerify) {
                            throw new AppError_1.default('Your email/password is incorrect');
                        }
